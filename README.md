...
Development: https://github.com/dart-lang/sdk
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/dart-sdk-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dart-sdk-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `dart-sdk` available on your platform:
...
```
pixi search dart-sdk --channel conda-forge
```
